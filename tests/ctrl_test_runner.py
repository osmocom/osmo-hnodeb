...
class TestCtrlHNB(TestCtrlBase):
    ...
    def ctrl_command(self):
        return ["./src/osmo-hnodeb/osmo-hnodeb", "-r", "tmp_dummy_sock", "-c",
...
def add_hnodeb_test(suite, workdir, klass):
    if not os.path.isfile(os.path.join(workdir, "src/osmo-hnodeb/osmo-hnodeb")):
        print("Skipping the hNodeB test")
        return
...
if __name__ == '__main__':
    ...
    add_hnodeb_test(suite, workdir, TestCtrlHNB)
